        ...
        <div class="coverage pr-1">
          <ul class="list-unstyled">
            <li class="list-item" v-for="coverage in coverage.coverages" :key="coverage.id">
              <a class="fund-manager" data-toggle="collapse" :href="`#collapse${coverage.id}`">
                <div class="row pl-2">
                  <div class="col">
                    <i class="fas fa-chess-rook text-grey"></i>
              ...
              <ul class="list-unstyled mb-1">
                <div class="collapse pl-4" :id="`collapse${coverage.id}`">
                  <li
                    class="funds"
...
.admin-sidebar .body li.funds a:focus {
  color: #fff!important;
  text-decoration: none;
  font-weight:bolder;
}
